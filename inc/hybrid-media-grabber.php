...
class Hybrid_Media_Grabber {
	...
	public function __construct( $args = array() ) {
		...
		$defaults = array(
			...
			'extra_details' => false, // Whether to send a more detailed response, or just the media (this is the default)
		);
	...
	public function get_media() {
		if ( true === $this->args['extra_details'] ) {
			return apply_filters( 'hybrid_media_grabber_media', array( 'content'=> $this->media, 'original' => $this->original_media, 'format' => $this->media_format ), $this, true );
		}
