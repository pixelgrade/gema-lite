	...
	class TI_About_Page {
		...
		public function get_plugin_icon( $arr ) {
			...
			if ( ! empty( $arr['svg'] ) ) {
				...
				$plugin_icon_url = get_template_directory_uri() . '/inc/admin/ti-about-page/images/placeholder_plugin.png';
			}
...
//						}
		...
		public function style_and_scripts( $hook_suffix ) {
			...
			if ( 'appearance_page_' . $this->theme_slug . '-welcome' == $hook_suffix ) {
				...
				wp_enqueue_script( 'ti-about-page-js', get_template_directory_uri() . '/inc/admin/ti-about-page/js/ti_about_page_scripts.js', array( 'jquery' ) );
				...
				wp_localize_script( 'ti-about-page-js', 'tiAboutPageObject', array(
					...
					'activating_string'        => __( 'Activating', 'gema-lite' )
				) );
