...
function gema_lite_register_required_plugins() {
	...
	$config = array(
		...
		'strings'          => array(
			...
			/* translators: %1$s = plugin name */
			'notice_can_install_required'     => _n_noop( 'Gema Lite requires the following plugin: %1$s.', 'Gema Lite requires the following plugins: %1$s.', '__theme_txtd' ),
			/* translators: %1$s = plugin name */
			'notice_can_install_recommended'  => _n_noop( 'Gema Lite recommends the following plugin: %1$s.', 'Gema Lite recommends the following plugins: %1$s.', '__theme_txtd' ),
			/* translators: %1$s = plugin name */
			...
			/* translators: %1$s = plugin name */
			'notice_ask_to_update'            => _n_noop( 'The following plugin needs to be updated to its latest version to ensure maximum compatibility with Gema Lite: %1$s.', 'The following plugins need to be updated to their latest version to ensure maximum compatibility with Gema Lite: %1$s.', '__theme_txtd' ),
			/* translators: %1$s = plugin name */
