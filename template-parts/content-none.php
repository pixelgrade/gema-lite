	...
	<main id="main" class="site-main" role="main">
		<div class="post__content">
			<div class="entry-content">
				<h1 class="page-title"><?php _e( 'Nothing Found', 'gema-lite' ); ?></h1>
				<div class="no-results  not-found">
					<?php if ( is_home() && current_user_can( 'publish_posts' ) ) : ?>

						<p><?php printf( wp_kses( __( 'Ready to publish your first post? <a href="%1$s">Get started here</a>.', 'gema-lite' ), array( 'a' => array( 'href' => array() ) ) ), esc_url( admin_url( 'post-new.php' ) ) ); ?></p>
